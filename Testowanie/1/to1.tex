...
\newcommand{\DataLaboratorium}{8 października 2014}
...
\section{Wnioski}
Laboratorium miało na celu zapoznanie nas z tokiem myślenia testera oprogramowania. Testując program, którego się nie programowało samemu umożliwia nam sprawdzenie czy program posiada wszystkie funkcje, które program powinien zawierać - a o których programista niekoniecznie pomyślał.
\end{document}
