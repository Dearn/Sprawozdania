...
\newcommand{\DataLaboratorium}{11 grudnia 2013}
...
\newcommand{\TytulLaboratirum}{Laboratorium 3\\Perceptron wielowarstwowy}
\frenchspacing
...
Celem laboratorium było wykonanie \emph{Perceptronu wielowarstwowego} w programie \emph{Scilab}.
...
\lstinputlisting[title=PerceptronWielowarstwowy.sce]{data/perceptronwielowarstwowy.sce}
